...
class CatalogRepository private constructor(
    ...
    companion object {
        ...
        fun getInstance(remoteData: RemoteDataSource, localData: LocalDataSource): CatalogRepository = instance ?: synchronized(this) {
            instance ?: CatalogRepository(remoteData, localData)
        }
    }
